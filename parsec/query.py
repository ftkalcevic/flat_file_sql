...
if __name__ == "__main__":
    ...
    sql = Sql("SELECT selection, mi, why.* from MY_STRUCT where mi >= 7 and mi in (1,2,3) or msa[1].simp2 between 1 and 5")
    #sql = Sql("Select mi, why.* from MY_STRUCT where msa[1].simp2 = 1")
